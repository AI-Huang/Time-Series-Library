#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# @Date    : 2025/04/25 11:40:06
# @Author  : 黄衎
# @Email   : ex_kan.huang@tcl.com
# @Desc    : None

# Copy from: https://github.com/thuml/Time-Series-Library/blob/main/utils/print_args.py, and modified

def log_args(args, logger):
    logger.info("\033[1m" + "Experiment Args" + "\033[0m")

    logger.info("\033[1m" + "Basic Config" + "\033[0m")
    logger.info(
        f'  {"Task Name:":<20}{args.task_name:<20}{"Is Training:":<20}{args.is_training:<20}')
    logger.info(
        f'  {"Model ID:":<20}{args.model_id:<20}{"Model:":<20}{args.model:<20}')
    logger.info('\n')

    logger.info("\033[1m" + "Data Loader" + "\033[0m")
    logger.info(
        f'  {"Data:":<20}{args.data:<20}{"Root Path:":<20}{args.root_path:<20}')
    logger.info(
        f'  {"Data Path:":<20}{args.data_path:<20}{"Features:":<20}{args.features:<20}')
    logger.info(
        f'  {"Target:":<20}{args.target:<20}{"Freq:":<20}{args.freq:<20}')
    ...
    logger.info(
        f'  {"Enc In:":<20}{args.enc_in:<20}{"Dec In:":<20}{args.dec_in:<20}')
    logger.info(
        f'  {"C Out:":<20}{args.c_out:<20}{"d model:":<20}{args.d_model:<20}')
    logger.info(
        f'  {"n heads:":<20}{args.n_heads:<20}{"e layers:":<20}{args.e_layers:<20}')
    logger.info(
        f'  {"d layers:":<20}{args.d_layers:<20}{"d FF:":<20}{args.d_ff:<20}')
    logger.info(
        f'  {"Moving Avg:":<20}{args.moving_avg:<20}{"Factor:":<20}{args.factor:<20}')
    logger.info(
        f'  {"Distil:":<20}{args.distil:<20}{"Dropout:":<20}{args.dropout:<20}')
    logger.info(
        f'  {"Embed:":<20}{args.embed:<20}{"Activation:":<20}{args.activation:<20}')
    logger.info('\n')

    logger.info("\033[1m" + "Run Parameters" + "\033[0m")
    logger.info(
        f'  {"Num Workers:":<20}{args.num_workers:<20}{"Itr:":<20}{args.itr:<20}')
    logger.info(
    ...
    logger.info(
        f'  {"Lradj:":<20}{args.lradj:<20}{"Use Amp:":<20}{args.use_amp:<20}')
    logger.info('\n')

    logger.info("\033[1m" + "GPU" + "\033[0m")
    logger.info(
        f'  {"Use GPU:":<20}{args.use_gpu:<20}{"GPU:":<20}{args.gpu:<20}')
    logger.info(
